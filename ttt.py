...
def concatenate():
    ...
    video_clip.fps = 1
    video_clip.write_videofile(f'{audio}.mp4',threads=8, fps=1,codec="libx264",audio_bitrate="192k",temp_audiofile=None)
...
button1 = Button(root ,text='Select Image',bg="#3d9984",fg="black", command=selecimg)
button1.place(x=180,y=150)
button1.config(font=("Arial 15 bold"))



button2 = Button(root ,text='Select Audio',bg="#8c4c3a", command=selecaudi)
button2.place(x=195,y=206)
